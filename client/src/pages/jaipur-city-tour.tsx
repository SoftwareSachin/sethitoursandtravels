    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-pink-50">
      ...
      <div id="attractions" className="py-20 bg-gradient-to-br from-orange-50 via-pink-50 to-yellow-50">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-20">
            <div className="relative overflow-hidden bg-gradient-to-br from-orange-500 via-pink-500 to-purple-600 rounded-3xl">
              {/* Background Pattern */}
              ...
              <div className="relative z-10 p-12 lg:p-16 text-center text-white">
                ...
                <div className="mb-8">
                  ...
                  <p className="text-xl md:text-2xl mb-4 opacity-95 max-w-4xl mx-auto leading-relaxed">
                    Join thousands of satisfied travelers on an unforgettable journey through Jaipur's royal heritage, 
                    majestic palaces, and vibrant culture.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12 max-w-4xl mx-auto">
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                    ...
                    <div className="text-sm opacity-90">UNESCO Sites</div>
                  </div>
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                    <div className="text-3xl font-bold text-yellow-300 mb-1">8hr</div>
                    <div className="text-sm opacity-90">Full Day Tour</div>
                  </div>
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                    <div className="text-3xl font-bold text-yellow-300 mb-1">1000+</div>
                    <div className="text-sm opacity-90">Happy Tourists</div>
                  </div>
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-12 max-w-5xl mx-auto text-left">
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                    ...
                    <p className="text-sm opacity-90">Professional drivers with deep knowledge of Jaipur's history and culture</p>
                  </div>
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                    <div className="flex items-center gap-3 mb-3">
                      <div className="w-10 h-10 bg-yellow-400 rounded-full flex items-center justify-center">
                      ...
                      <h4 className="font-semibold">Flexible Itinerary</h4>
                    </div>
                    <p className="text-sm opacity-90">Customize your tour timing and attractions based on your preferences</p>
                  </div>
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                    <div className="flex items-center gap-3 mb-3">
                      <div className="w-10 h-10 bg-yellow-400 rounded-full flex items-center justify-center">
                      ...
                      <h4 className="font-semibold">Comfortable Vehicles</h4>
                    </div>
                    <p className="text-sm opacity-90">Air-conditioned cars with professional drivers for maximum comfort</p>
                  </div>
                </div>
                ...
                <div className="flex flex-col lg:flex-row gap-4 justify-center items-center">
                  <Button 
                    size="lg"
                    className="bg-white text-orange-600 hover:bg-yellow-50 px-10 py-6 text-xl font-bold shadow-2xl transform transition-all duration-300 hover:scale-105 rounded-full"
                    onClick={() => handleBooking('फुल डे जयपुर टूर - प्रीमियम पैकेज')}
                  >
                    <Car className="w-6 h-6 mr-3" />
                    Book Complete Tour Now
                  </Button>
                  <div className="flex gap-3">
                    <Button 
                      size="lg"
                      variant="outline"
                      className="border-2 border-white/60 text-white hover:bg-white/10 px-6 py-6 text-lg font-semibold rounded-full backdrop-blur-sm bg-white/5 shadow-lg"
                      onClick={() => document.getElementById('pricing')?.scrollIntoView({ behavior: 'smooth' })}
                    >
                    ...
                    <Button 
                      ...
                      className="border-2 border-white/60 text-white hover:bg-white/10 px-6 py-6 text-lg font-semibold rounded-full backdrop-blur-sm bg-white/5 shadow-lg"
                      onClick={() => {
                        const message = `नमस्कार! मैं जयपुर सिटी टूर के बारे में जानकारी चाहता हूँ। कृपया डिटेल्स भेजें।`;
                        window.open(`https://wa.me/917727021780?text=${encodeURIComponent(message)}`, '_blank');
                      }}
                    >
